...
exports.updatedDataNoEmail = void 0;
...
function updatedDataNoEmail() {
    var updatedRecord = [];
    files.forEach(function (file) {
        var ws = file.Sheets['New Data'];
        var wsJson = xlsx.utils.sheet_to_json(ws);
        wsJson.map(function (record) {
            console.log(record);
            if (!!record.candFirstName ||
                !!record.tfirstName ||
                !!record.candLastName) {
...
exports.updatedDataNoEmail = updatedDataNoEmail;
